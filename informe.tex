...
El paradigma Branch & Bound (B\&B) es una de las principales herramientas en la construcción de soluciones exactas para problemas de optimización NP-Hard.
...
Inicialmente, solo un subconjunto existe (el espacio de solución completo) y la mejor solución hayada es $\infty$. Los subespacios no explorados se representan como nodos en un árbol de búsqueda generado dinámicamente, que inicialmente solo contiene la raiz. En cada paso de una iteración de B\&B se procesa un nodo.
 ...
 Si la selección del siguiente subproblema está basadfa en el valor de la cota de los subproblemas, entonces la primera operación en una iteración luego de elegir un nodo es ramificar.
